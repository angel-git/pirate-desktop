; Installer Variables
#define AppName "Piratebay-downloader"
#define AppVersion "0.0.1"
#define AppPublisher "Angel Team"
#define AppURL "http://github.com"
...
AppId={{F4B2C5C1-F084-4858-B9C3-E642F5C12BBC}
...
; Don't ask for a install folder (it goes into \Users\Username\AppData\Roaming\piratebay-downloader\, which doesn't require admin privileges)
UsePreviousAppDir=no
DefaultDirName={userappdata}\piratebay-downloader
